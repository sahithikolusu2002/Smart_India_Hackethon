...
#     else:
#         video_name = os.path.splitext(os.path.basename(str(filename)))[0]
...
#         cv.putText(
#             frame, f"FPS: {fps}", (20, 50), cv.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 2
#         )
...
# # Example usage:
# # detectPotholeonVideo('your_video_filename.mp4')
